...
export const errorManager = {
  ...
  REQUIRED_END_LOCATION: {
    type: 'REQUIRED_END_LOCATION',
    message: 'endLocationName value required',
    code: 400,
    severityCode: severityCode.LOW
  },
  REQUIRED_BOOKED_HOURS: {
    type: 'REQUIRED_BOOKED_HOURS',
    message: 'bookedHours value required',
    code: 400,
    severityCode: severityCode.LOW
  },
  INVALID_BOOKED_HOURS: {
    type: 'INVALID_BOOKED_HOURS',
    message: 'Minimum booking time is 1 hour',
    code: 400,
    severityCode: severityCode.LOW
  }
};
